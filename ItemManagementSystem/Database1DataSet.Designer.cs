...
namespace ItemManagementSystem {
    ...
    public partial class Database1DataSet : global::System.Data.DataSet {
        ...
        public partial class ItemsDataTable : global::System.Data.TypedTableBase<ItemsRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public ItemsRow AddItemsRow(string itemId, string name, decimal price, string Department) {
            ...
            private void InitClass() {
                ...
                this.columnitemId.MaxLength = 250;
...
namespace ItemManagementSystem.Database1DataSetTableAdapters {
    ...
    public partial class ItemsTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Items] WHERE (([itemId] = @Original_itemId) AND ([name] = @Ori" +
                "ginal_name) AND ([price] = @Original_price) AND ([Department] = @Original_Depart" +
                "ment))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Items] ([itemId], [name], [price], [Department]) VALUES (@item" +
                "Id, @name, @price, @Department);\r\nSELECT itemId, name, price, Department FROM It" +
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Items] SET [itemId] = @itemId, [name] = @name, [price] = @price, [Department] = @Department WHERE (([itemId] = @Original_itemId) AND ([name] = @Original_name) AND ([price] = @Original_price) AND ([Department] = @Original_Department));
SELECT itemId, name, price, Department FROM Items WHERE (itemId = @itemId)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::ItemManagementSystem.Properties.Settings.Default.Database1ConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT itemId, name, price, Department FROM dbo.Items";
        ...
        public virtual int Delete(string Original_itemId, string Original_name, decimal Original_price, string Original_Department) {
        ...
        public virtual int Insert(string itemId, string name, decimal price, string Department) {
            if ((itemId == null)) {
        ...
        public virtual int Update(string itemId, string name, decimal price, string Department, string Original_itemId, string Original_name, decimal Original_price, string Original_Department) {
            if ((itemId == null)) {
                throw new global::System.ArgumentNullException("itemId");
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string name, decimal price, string Department, string Original_itemId, string Original_name, decimal Original_price, string Original_Department) {
            return this.Update(Original_itemId, name, price, Department, Original_itemId, Original_name, Original_price, Original_Department);
        }
    }
